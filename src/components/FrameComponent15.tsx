          ...
          <div className={styles.frameContainer}>
            <div className={styles.frameDiv}>
              ...
              <div className={styles.greenVitalityBlend}>
                Green Vitality Blend has become my daily essential. The organic
                ingredients make me feel invigorated, and the immune support is
                unmatched. It's a game-changer for my overall well-being!
              </div>
            ...
            <div className={styles.frameParent1}>
              ...
              <div className={styles.pureGlowCollagen}>
                ...
                rejuvenated and hydrated. The noticeable radiance is incredible.
                A must for anyone wanting healthy, glowing skin.”
              </div>
            ...
            <div className={styles.frameParent3}>
              ...
              <div className={styles.sleepSerenityCapsules}>
                “Sleep Serenity Capsules have transformed my nights. The natural
                relaxation is remarkable. I wake up refreshed and ready to
                tackle the day. Highly recommend for quality sleep!”
              </div>
