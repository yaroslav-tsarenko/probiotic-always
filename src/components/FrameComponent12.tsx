      ...
      <div className={styles.frameParent}>
        ...
        <div className={styles.frameDiv}>
          <div className={styles.greenVitalityBlendParent}>
            <h1 className={styles.greenVitalityBlend}>Green Vitality Blend</h1>
            ...
            <div className={styles.revitalizeWithNutrientRich}>
              Revitalize with nutrient-rich greens. Boost energy and immunity.
          ...
          <div className={styles.goodForParent}>
            ...
            <div className={styles.frameParent2}>
              <div className={styles.crueltyFreeWellnessWrapper}>
                <div className={styles.crueltyFreeWellness}>
