...
const ProductListing: FunctionComponent = () => {
  return (
    <div className={styles.productListing1}>
      ...
      <div className={styles.productListing1Child} />
      <div className={styles.productListing1Inner}>
        <img
      ...
      <main className={styles.instanceGroup}>
        ...
        <section className={styles.frameWrapper}>
          <div className={styles.rectangleParent}>
            ...
            <div className={styles.discoverOurWellnessWrapper}>
              <h1 className={styles.discoverOurWellness}>
                Discover Our Wellness
              </h1>
            </div>
            <h3 className={styles.exploreOurCurated}>
              Explore our curated collection of premium wellness products, each
              meticulously crafted to elevate your health naturally.
            </h3>
          </div>
        </section>
        <FrameComponent9 />
